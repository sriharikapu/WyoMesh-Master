...
'0xa3c0346a7af69f2f3b79b4c749fd9202098cd097',//address of contract on the blockchain
{
from: '0x82c24a9998dfa2846d4f244b6e3cfdc0197b5089',
gasPrice: '20000000000'
});

MasterContract.methods.addDevice('0x0dF9b5b8b38bAFF8D729Bcf853EF54099F88a3ce').send({from: '0x8D8d94dF3669F804F27f5090e67eDDFb9a4e80D0'});
MasterContract.methods.submitHash('temp is 90').send({from: '0x0dF9b5b8b38bAFF8D729Bcf853EF54099F88a3ce'});
MasterContract.methods.getHash(0).call({from: '0x0dF9b5b8b38bAFF8D729Bcf853EF54099F88a3ce'})
.then(console.log);
